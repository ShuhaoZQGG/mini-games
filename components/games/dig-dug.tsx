...
export default function DigDug() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('dig-dugHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('dig-dugHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Dig Dug</h2>
              <p className="text-gray-600">Underground monster hunter with inflation mechanic</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Dig Dug gameplay</p>
