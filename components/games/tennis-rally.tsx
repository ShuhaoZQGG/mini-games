...
export default function TennisRally() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('tennis-rallyHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('tennis-rallyHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Tennis Rally</h2>
              <p className="text-gray-600">Volley survival with increasing speed</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Tennis Rally gameplay</p>
