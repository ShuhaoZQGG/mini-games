...
export default function Mancala() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('mancalaHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('mancalaHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Mancala</h2>
              <p className="text-gray-600">Ancient counting game with capture rules</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Mancala gameplay</p>
