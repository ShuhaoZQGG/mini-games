...
export default function SoccerPenalty() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('soccer-penaltyHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('soccer-penaltyHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Soccer Penalty</h2>
              <p className="text-gray-600">Penalty kick with goalkeeper AI</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Soccer Penalty gameplay</p>
