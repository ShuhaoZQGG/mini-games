...
interface EcosystemBalanceGameProps {
  levelConfig: {
    difficulty: number
    speed: number
    targetScore: number
...
function EcosystemBalanceGame({ levelConfig, onScore }: EcosystemBalanceGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Ecosystem Balance</h2>
              <p className="text-muted-foreground mb-8">Simple predator-prey dynamics</p>
...
export default function EcosystemBalance() {
  ...
  return (
    <GameWithLevels
      gameId="ecosystem-balance"
      gameName="Ecosystem Balance"
      levels={levels}
      renderGame={(config, onScore) => (
        <EcosystemBalanceGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
