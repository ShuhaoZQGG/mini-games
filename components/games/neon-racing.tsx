...
function NeonRacingGame({ levelConfig, onScore }: NeonRacingGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Neon Racing</h2>
              <p className="text-muted-foreground mb-8">Tron-style racing with power-ups</p>
...
export default function NeonRacing() {
  ...
  return (
    <GameWithLevels
      gameId="neon-racing"
      gameName="Neon Racing"
      levels={levels}
      renderGame={(config, onScore) => (
        <NeonRacingGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
