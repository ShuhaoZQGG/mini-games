...
interface ParkourRunnerGameProps {
  levelConfig: {
    difficulty: number
    speed: number
    targetScore: number
...
function ParkourRunnerGame({ levelConfig, onScore }: ParkourRunnerGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Parkour Runner</h2>
              <p className="text-muted-foreground mb-8">Advanced obstacle course navigation</p>
...
export default function ParkourRunner() {
  ...
  return (
    <GameWithLevels
      gameId="parkour-runner"
      gameName="Parkour Runner"
      levels={levels}
      renderGame={(config, onScore) => (
        <ParkourRunnerGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
