...
export default function Centipede() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('centipedeHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('centipedeHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Centipede</h2>
              <p className="text-gray-600">Mushroom field shooter with segments</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Centipede gameplay</p>
