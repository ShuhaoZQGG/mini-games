...
export default function Xiangqi() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('xiangqiHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('xiangqiHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Xiangqi</h2>
              <p className="text-gray-600">Chinese chess with river and palace</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Xiangqi gameplay</p>
