...
export default function BoxingMatch() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('boxing-matchHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('boxing-matchHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Boxing Match</h2>
              <p className="text-gray-600">Timing-based combat with combos</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Boxing Match gameplay</p>
