...
function FaceMemoryGame({ levelConfig, onScore }: FaceMemoryGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Face Memory</h2>
              <p className="text-muted-foreground mb-8">Facial recognition and recall</p>
...
export default function FaceMemory() {
  ...
  return (
    <GameWithLevels
      gameId="face-memory"
      gameName="Face Memory"
      levels={levels}
      renderGame={(config, onScore) => (
        <FaceMemoryGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
