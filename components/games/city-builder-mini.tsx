...
interface CityBuilderMiniGameProps {
  levelConfig: {
    difficulty: number
    speed: number
    targetScore: number
...
function CityBuilderMiniGame({ levelConfig, onScore }: CityBuilderMiniGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">City Builder Mini</h2>
              <p className="text-muted-foreground mb-8">Simplified urban planning</p>
...
export default function CityBuilderMini() {
  ...
  return (
    <GameWithLevels
      gameId="city-builder-mini"
      gameName="City Builder Mini"
      levels={levels}
      renderGame={(config, onScore) => (
        <CityBuilderMiniGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
