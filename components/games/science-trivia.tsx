...
export default function ScienceTrivia() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('science-triviaHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('science-triviaHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Science Trivia</h2>
              <p className="text-gray-600">STEM knowledge quiz with categories</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Science Trivia gameplay</p>
