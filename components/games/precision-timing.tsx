...
interface PrecisionTimingGameProps {
  levelConfig: {
    difficulty: number
    speed: number
    targetScore: number
...
function PrecisionTimingGame({ levelConfig, onScore }: PrecisionTimingGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Precision Timing</h2>
              <p className="text-muted-foreground mb-8">Multi-layered timing challenges</p>
...
export default function PrecisionTiming() {
  ...
  return (
    <GameWithLevels
      gameId="precision-timing"
      gameName="Precision Timing"
      levels={levels}
      renderGame={(config, onScore) => (
        <PrecisionTimingGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
