...
function MarbleMazeGame({ levelConfig, onScore }: MarbleMazeGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Marble Maze</h2>
              <p className="text-muted-foreground mb-8">Tilt-controlled marble navigation</p>
...
export default function MarbleMaze() {
  ...
  return (
    <GameWithLevels
      gameId="marble-maze"
      gameName="Marble Maze"
      levels={levels}
      renderGame={(config, onScore) => (
        <MarbleMazeGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
