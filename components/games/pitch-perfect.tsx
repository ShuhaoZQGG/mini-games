...
function PitchPerfectGame({ levelConfig, onScore }: PitchPerfectGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Pitch Perfect</h2>
              <p className="text-muted-foreground mb-8">Identify musical notes and intervals</p>
...
export default function PitchPerfect() {
  ...
  return (
    <GameWithLevels
      gameId="pitch-perfect"
      gameName="Pitch Perfect"
      levels={levels}
      renderGame={(config, onScore) => (
        <PitchPerfectGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
