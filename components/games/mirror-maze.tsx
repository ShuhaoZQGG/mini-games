...
function MirrorMazeGame({ levelConfig, onScore }: MirrorMazeGameProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="bg-gradient-to-b from-background to-muted rounded-lg p-8 min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Mirror Maze</h2>
              <p className="text-muted-foreground mb-8">Light reflection and redirection</p>
  ...
  return (
    <GameWithLevels
      ...
      renderGame={(config, onScore) => (
        <MirrorMazeGame levelConfig={config} onScore={onScore} />
      )}
      getStars={getStars}
    />
  )
