...
export default function OthelloAdvanced() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('othello-advancedHighScore')
  ...
  useEffect(() => {
    if (score > highScore) {
      setHighScore(score)
      localStorage.setItem('othello-advancedHighScore', score.toString())
    }
  }, [score, highScore])
        ...
        {gameState === 'menu' && (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-bold">Othello Advanced</h2>
              <p className="text-gray-600">Enhanced reversi with AI strategies</p>
            </div>
        ...
        {gameState === 'playing' && (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p>This is a placeholder for Othello Advanced gameplay</p>
